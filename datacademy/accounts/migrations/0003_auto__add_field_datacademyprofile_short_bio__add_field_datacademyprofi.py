...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatacademyProfile.short_bio'
        db.add_column(u'accounts_datacademyprofile', 'short_bio',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DatacademyProfile.linkedin_profile'
        db.add_column(u'accounts_datacademyprofile', 'linkedin_profile',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatacademyProfile.short_bio'
        db.delete_column(u'accounts_datacademyprofile', 'short_bio')

        # Deleting field 'DatacademyProfile.linkedin_profile'
        db.delete_column(u'accounts_datacademyprofile', 'linkedin_profile')
