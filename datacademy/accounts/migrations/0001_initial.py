...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DatacademyProfile'
        db.create_table(u'accounts_datacademyprofile', (
        ...
        db.send_create_signal(u'accounts', ['DatacademyProfile'])


    def backwards(self, orm):
        # Deleting model 'DatacademyProfile'
        db.delete_table(u'accounts_datacademyprofile')
